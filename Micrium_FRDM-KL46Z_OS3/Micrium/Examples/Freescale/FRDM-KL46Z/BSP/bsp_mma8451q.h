...
#ifndef  BSP_MMA8451Q_PRESENT
#define  BSP_MMA8451Q_PRESENT
...
#ifdef   BSP_MMA8451Q_MODULE
#define  BSP_MMA8451Q_EXT
#else
#define  BSP_MMA8451Q_EXT  extern
#endif
...
void        BSP_MMA8451_Init       (void); //prepare I2C port

void        BSP_MMA8451_Active     (CPU_INT08U  DynamicRange);

CPU_INT08U  BSP_MMA8451_Read_Reg   (CPU_INT08U  addr);

void        BSP_MMA8451_Write_Reg  (CPU_INT08U  addr,
	                                CPU_INT08U  data);

void        BSP_Accel_Read(void);

void        BSP_Accel_Test(void);

CPU_INT32S  BSP_iAcclReadX(void);

CPU_INT32S  BSP_iAcclReadY(void);

CPU_INT32S  BSP_iAcclReadZ(void);
